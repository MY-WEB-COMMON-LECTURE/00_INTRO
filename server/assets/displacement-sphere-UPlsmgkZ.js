...
import { g as useTheme, u as useInViewport, b as useWindowSize, e as media, T as Transition } from "./server-build-DqnRUDG6.js";
...
const DisplacementSphere = (props) => {
  ...
  useEffect(() => {
    const dirLight = new DirectionalLight(theme === "light" ? 16777215 : 65535, theme === "light" ? 1.8 : 2);
    const ambientLight = new AmbientLight(theme === "light" ? 16777215 : 65535, theme === "light" ? 2.7 : 0.4);
