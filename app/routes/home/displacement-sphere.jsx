...
export const DisplacementSphere = props => {
  ...
  useEffect(() => {
    const dirLight = new DirectionalLight(theme === 'light' ? 0xffffff : 0x00ffff, theme === 'light' ? 1.8 : 2.0);
    const ambientLight = new AmbientLight(theme === 'light' ? 0xffffff : 0x00ffff, theme === 'light' ? 2.7 : 0.4);
