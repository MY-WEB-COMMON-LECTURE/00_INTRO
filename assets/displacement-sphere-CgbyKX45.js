import{r,j as y}from"./jsx-runtime-DexIYAB0.js";import{a as R,u as L}from"./image-CxFi2hyW.js";import{u as M,g as z,b as C}from"./heading-Bqb4dnA5.js";import{u as E}from"./useWindowSize-mzNSXuUf.js";import{V as I,W as j,L as q,e as A,S as D,f as G,U as V,g as F,M as U,c as k,a as T,D as H,A as W,r as N}from"./three-BzMM05cl.js";import{t as B}from"./throttle-BgiUmwhn.js";import{u as h}from"./use-spring-z5M_zw8D.js";import"./components-D1Eb6D8q.js";import"./index-CY1R126H.js";const O=`#define PHONG\r
\r
...
`,Y="_canvas_1pqfq_1",J={canvas:Y},P={stiffness:30,damping:20,mass:2},on=w=>{const{theme:g}=R(),b=r.useRef(Date.now()),m=r.useRef(),S=r.useRef(),c=r.useRef(),o=r.useRef(),a=r.useRef(),d=r.useRef(),l=r.useRef(),p=r.useRef(),x=r.useRef(),t=r.useRef(),s=M(),f=L(m),_=E(),v=h(0,P),u=h(0,P);return r.useEffect(()=>{const{innerWidth:n,innerHeight:e}=window;return S.current=new I(.8,.5),c.current=new j({canvas:m.current,antialias:!1,alpha:!0,powerPreference:"high-performance",failIfMajorPerformanceCaveat:!0}),c.current.setSize(n,e),c.current.setPixelRatio(1),c.current.outputColorSpace=q,o.current=new A(54,n/e,.1,100),o.current.position.z=52,a.current=new D,p.current=new G,p.current.onBeforeCompile=i=>{l.current=V.merge([i.uniforms,{time:{type:"f",value:0}}]),i.uniforms=l.current,i.vertexShader=X,i.fragmentShader=O},r.startTransition(()=>{x.current=new F(32,128,128),t.current=new U(x.current,p.current),t.current.position.z=0,t.current.modifier=Math.random(),a.current.add(t.current)}),()=>{k(a.current),T(c.current)}},[]),r.useEffect(()=>{const n=new H(g==="light"?16777215:65535,g==="light"?1.8:2),e=new W(g==="light"?16777215:65535,g==="light"?2.7:.4);return n.position.z=200,n.position.x=100,n.position.y=100,d.current=[n,e],d.current.forEach(i=>a.current.add(i)),()=>{N(d.current)}},[g]),r.useEffect(()=>{const{width:n,height:e}=_,i=e+e*.3;c.current.setSize(n,i),o.current.aspect=n/i,o.current.updateProjectionMatrix(),s&&c.current.render(a.current,o.current),n<=z.mobile?(t.current.position.x=14,t.current.position.y=10):n<=z.tablet?(t.current.position.x=18,t.current.position.y=14):(t.current.position.x=22,t.current.position.y=16)},[s,_]),r.useEffect(()=>{const n=B(e=>{const i={x:e.clientX/window.innerWidth,y:e.clientY/window.innerHeight};v.set(i.y/2),u.set(i.x/2)},100);return!s&&f&&window.addEventListener("mousemove",n),()=>{window.removeEventListener("mousemove",n)}},[f,s,v,u]),r.useEffect(()=>{let n;const e=()=>{n=requestAnimationFrame(e),l.current!==void 0&&(l.current.time.value=5e-5*(Date.now()-b.current)),t.current.rotation.z+=.001,t.current.rotation.x=v.get(),t.current.rotation.y=u.get(),c.current.render(a.current,o.current)};return!s&&f?e():c.current.render(a.current,o.current),()=>{cancelAnimationFrame(n)}},[f,s,v,u]),y.jsx(C,{in:!0,timeout:3e3,nodeRef:m,children:({visible:n,nodeRef:e})=>y.jsx("canvas",{"aria-hidden":!0,className:J.canvas,"data-visible":n,ref:e,...w})})};export{on as DisplacementSphere};
